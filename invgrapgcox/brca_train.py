...
from model.Encoder import SAGEEncoder_breast_new
...
def main():
    ...
    paths = {
        "train": "./dataset/new/BRCA_Yau_updated_imputed_updated.csv",
        "test0": "./dataset/new/BRCA_Miller_updated_imputed_updated.csv",
        "test1": "./dataset/new/BRCA_Vijver_updated_imputed_updated.csv",
        "test2": "./dataset/new/BRCA_Chin_updated_imputed_updated.csv",
        "test3": "./dataset/new/BRCA_Caldas_updated_imputed_updated.csv"
    }
    ...
    encoder = SAGEEncoder_breast_new(in_dim).to(device)
    gae = VGAE(encoder).to(device)
    optimizer = optim.Adam(gae.parameters(), lr=0.0014426608418647282, weight_decay=8.11816526055785e-06)
    ...
    cph = CoxPHFitter(penalizer=0.004205206163926426)
    ...
    cph2 = CoxPHFitter(penalizer=0.004205206163926426)
