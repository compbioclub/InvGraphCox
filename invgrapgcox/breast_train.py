...
from model.Encoder import SAGEEncoder_breast
...
def main():
    ...
    paths = {
        "train": "./dataset/breast_cancer/train_median.csv",
        "test0": "./dataset/breast_cancer/test0_median.csv",
        "test1": "./dataset/breast_cancer/test1_median.csv",
        "test2": "./dataset/breast_cancer/test2_median.csv",
        "test3": "./dataset/breast_cancer/test3_median.csv",
    }
    ...
    encoder = SAGEEncoder_breast(in_dim).to(device)
    ...
    emb_df["train"], [emb_df["test0"], emb_df["test1"], emb_df["test2"]] = centre_to_train_mean(emb_df["train"], [emb_df["test0"], emb_df["test1"], emb_df["test2"]])
