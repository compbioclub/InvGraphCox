...
from model.Encoder import SAGEEncoder_mela
...
def main():
    ...
    paths = {
        "train": "./dataset/mela_cancer/train_median.csv",
        "test0": "./dataset/mela_cancer/test0_median.csv",
        "test1": "./dataset/mela_cancer/test1_median.csv",
        "test2": "./dataset/mela_cancer/test2_median.csv",
        "test3": "./dataset/mela_cancer/test3_median.csv",
    }
    ...
    for k in dfs:
        dfs[k]["Survival.months"] = dfs[k]["Survival.months"] / 30.0
    ...
    encoder = SAGEEncoder_mela(in_dim).to(device)
    ...
    emb_df["train"], [emb_df["test0"], emb_df["test1"], emb_df["test3"]] = centre_to_train_mean(emb_df["train"], [emb_df["test0"], emb_df["test1"], emb_df["test3"]])
    ...
    summary = cph.summary
    top_features = summary["p"].nsmallest(5).index
